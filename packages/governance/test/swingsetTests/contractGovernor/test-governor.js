...
const expectedcontractGovernorStartLog = [
  ...
  'Voter Alice cast a ballot for {"changeParam":"MalleableNumber","proposedValue":"[299792458n]"}',
  'Voter Bob cast a ballot for {"noChange":"MalleableNumber"}',
  'Voter Carol cast a ballot for {"noChange":"MalleableNumber"}',
  'Voter Dave cast a ballot for {"changeParam":"MalleableNumber","proposedValue":"[299792458n]"}',
  'Voter Emma cast a ballot for {"changeParam":"MalleableNumber","proposedValue":"[299792458n]"}',
  '@@ tick:1 @@',
  '@@ tick:2 @@',
  '@@ tick:3 @@',
  '&& running a task scheduled for 3. &&',
  'vote outcome: {"changeParam":"MalleableNumber","proposedValue":"[299792458n]"}',
